...
function draw() {
    ...
    objects.colorCube.draw(gl, ctx.aVertexPositionId, ctx.aVertexColorId, ctx.uIsTextureId);
    ...
    objects.textureCube.draw(gl, ctx.aVertexPositionId, ctx.aVertexColorId, ctx.aVertexTextureCoordId, ctx.uSamplerId, ctx.uIsTextureId, lennaTxt.textureObj);
}
