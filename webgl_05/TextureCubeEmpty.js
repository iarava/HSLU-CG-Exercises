...
function TextureCube(gl, color) {
    ...
    function defineTextureCoord(gl) {
        // define TextureCoord for the cube
        var textureCoord = [
            // vordere Fläche
            0.0,  0.0,
            1.0,  0.0,
    ...
    return {
        ...
        bufferTextureCoord: defineTextureCoord(gl),
        bufferColor: defineColors(color),

        draw: function(gl, aVertexPositionId, aVertexColorId, aVertexTextureCoordId, uSamplerId, uIsTextureId, textureObject) {
            gl.uniform1i(uIsTextureId, 1);
